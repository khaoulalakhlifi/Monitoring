...
# Enregistrez les prédictions dans le dictionnaire
predictions = {
    'temperature_prediction': float(prediction_temperature),
    'humidity_prediction': float(prediction_humidity)
}

# Affichez les prédictions avant l'enregistrement
print("Predictions to be saved:")
print(predictions)

with open(r'C:\Users\pc\Desktop\4 eme annee\Interconnection Reseaux\Monitoring\app\admin\templates\admin\predictions.json', 'w') as json_file:
    json.dump(predictions, json_file)


print(f'Les prédictions ont été enregistrées dans predictions.json')
